...
Extrados= Extrados-real(Extrados(length(Extrados)));
Intrados = Intrados-real(Intrados(length(Intrados)));
Extrados = Extrados/(real(Extrados(1)));
Intrados = Intrados/(real(Intrados(1)));
