...
b = input('\n   --> Entrez ordonnée du centre du cercle (entre 0 et 1): ');
Uo = input('\n   --> Entrez la vitesse à linfini amont (m.s-1): ');
...
% fprintf('\n');
% disp(['L équation de lextrados du profil est : (',num2str(G(1)),')*x^8 + (',num2str(G(2)),')*x^7 + (',num2str(G(3)),')*x^6 + (',num2str(G(4)),')*x^5 + (',num2str(G(5)),')*x^4 + (',num2str(G(6)),')*x^3 + (',num2str(G(7)),')*x^2 + (',num2str(G(8)),')*x + (',num2str(G(9)),').']);
% fprintf('\n');
% disp(['L équation de lintrados du profil est : (',num2str(H(1)),')*x^8 + (',num2str(H(2)),')*x^7 + (',num2str(H(3)),')*x^6 + (',num2str(H(4)),')*x^5 + (',num2str(H(5)),')*x^4 + (',num2str(H(6)),')*x^3 + (',num2str(H(7)),')*x^2 + (',num2str(H(8)),')*x + (',num2str(H(9)),').']);
 fprintf('\n');
...
b = input('\n  --> Entrez ordonnée du centre du cercle : ');
